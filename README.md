...
- `ROADMAP.md` — original performance-rewrite and math-output plan.
- `PERFORMANCE_ROADMAP.md` — follow-up plan covering rolling hash, snapshot-based mu recovery, heartbeat, checkpointing, and work-stealing.
...
See `ROADMAP.md` for the math-output plan (cycle-length / tail statistics, OEIS b-files, notebook) and `PERFORMANCE_ROADMAP.md` for the perf history (rolling hash, snapshot-based mu recovery, heartbeat, checkpointing, work-stealing).
